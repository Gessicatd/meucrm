// ============================================================
// POST /api/v1/groups/participants — manage WhatsApp group
// participants via RyzeAPI.
//
// All parameters are in the JSON body — no URL encoding needed
// for group JIDs containing @.
//
...
export async function POST(request: Request) {
  try {
    ...
    if (!groupId) {
      return fail('bad_request', 'group_id (group JID) is required', 400);
    }
